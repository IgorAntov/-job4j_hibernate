...
<div class="container">
    ...
    <c:if test="${sessionScope.user == author && status == 'not sold'}">
        <div class="container-fluid">
            <form action='${pageContext.request.contextPath}/adsupdate' id="myForm" method = 'post'>
                <input type='hidden' name='id' value="<c:out value="${id}"></c:out>"></br>
    ...
    <table class="table table-bordered" id='table'>
        ...
        <tr>
            <td> Title </td><td> <c:out value="${title}"></c:out> </td>
        </tr>
        <tr>
            <td> Desc </td><td> <c:out value="${itemdesc}"></c:out> </td>
        </tr>
        <tr>
            <td> Cost </td><td> <c:out value="${cost}"></c:out> </td>
        </tr>
        <tr>
            <td> Mileage </td><td> <c:out value="${mileage}"></c:out> </td>
        </tr>
        <tr>
            <td> Power </td><td> <c:out value="${power}"></c:out> </td>
        </tr>
        <tr>
            <td> Body </td><td> <c:out value="${body}"></c:out> </td>
        </tr>
        <tr>
            <td> Brand </td><td> <c:out value="${brand}"></c:out> </td>
        </tr>
        <tr>
            <td> Drive </td><td> <c:out value="${drive}"></c:out> </td>
        </tr>
        <tr>
            <td> Engine </td><td> <c:out value="${engine}"></c:out> </td>
        </tr>
        <tr>
            <td> Transmission </td><td> <c:out value="${transmission}"></c:out> </td>
        </tr>
        <tr>
            <td> Wheel </td><td> <c:out value="${wheel}"></c:out> </td>
        </tr>
